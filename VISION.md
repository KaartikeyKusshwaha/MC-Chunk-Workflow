...
## Production Workflows That Inspired Strata

Before starting Strata, I spent considerable time building Blender production workflows with AI coding agents. Through repeated revisions, visual analysis, experimentation, shader refinement, lighting iteration, compositing, and backtracking, I gradually developed workflows capable of producing cinematic Minecraft scenes.

Those workflows are not what Version 1 currently delivers. Instead, they represent the production knowledge that motivated Strata. The long-term goal is to capture proven production workflows as reusable, deterministic pipeline stages rather than rediscovering them in every project.

![Daytime cinematic environment](docs/images/forest_daytime.png)
*Daytime cinematic environment. Developed through repeated Blender workflow refinement using AI coding agents.*

![Night lighting workflow](docs/images/night_scene.png)
*Night lighting workflow. Developed through repeated Blender workflow refinement using AI coding agents.*

![Torch lighting experiment](docs/images/steve_cave.png)
*Torch lighting experiment. Developed through repeated Blender workflow refinement using AI coding agents.*

![Environment compositing study](docs/images/sky_clouds.png)
*Environment compositing study. Developed through repeated Blender workflow refinement using AI coding agents.*

These images demonstrate the production workflows that inspired Strata's architecture. They are examples of production experience rather than the current feature set of Version 1.
